...
print(f'In the "Plate list" {len(unique_numbers)} unique numbers')

if plate_number in plates_list:
    print(f'Plate number {plate_number} is in the "Plate list"')
else:
    print(f'Plate number {plate_number} is not in the "Plate list"')
